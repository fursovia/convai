...
from model.input_fn import input_fn, input_fn2, input_fn_rawtext
...
parser.add_argument('--data_dir', default='/data/i.anokhin/convai/data_convai', #data_convai_string
